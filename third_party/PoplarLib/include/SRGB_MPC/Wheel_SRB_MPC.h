...
#ifndef XIAOTIANHYBRID_WHEEL_SRB_MPC_H
#define XIAOTIANHYBRID_WHEEL_SRB_MPC_H
...
namespace Wheel_SRB_MPC {
    ...
    class Wheel_SRB_MPC_IMPL {
    public:

        explicit Wheel_SRB_MPC_IMPL(size_t horizon, RealNum dt);
        ...
        void setWeight(ConstVecRef Qx, const double alpha, ConstVecRef Wxy);
        
        void setHipPosition(ConstVecRef hip);
        ...
        ConstVecRef getDiscreteOptimizedStates();

        ConstVecRef getOptimalControlInputs();

        ConstVecRef getCurrentDesiredControlInputs();
    ...
    private:
        ...
        Vec _discreteOptimizedStates, _optimalControlInputs;
        Vec16 _input_des;
        ...
        Mat3 T_inv, R_wb, Iworld, Iw_inv, Rz;
...
#endif //XIAOTIANHYBRID_WHEEL_SRB_MPC_H
