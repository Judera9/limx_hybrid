...
if(NOT "/home/clear/limx_hybrid2/wheel_legged_gazebo_ros/src/legged_gazebo/include " STREQUAL " ")
  set(legged_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/clear/limx_hybrid2/wheel_legged_gazebo_ros/src/legged_gazebo/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'legged_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/clear/limx_hybrid2/wheel_legged_gazebo_ros/src/legged_gazebo/${idir}'.  ${_report}")
    endif()
